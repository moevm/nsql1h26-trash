...
const Sidebar = ({ activePage, userName = "Алексей П." }) => {
            ...
            <div className="p-6">
                ...
                <div className="flex flex-col gap-1 mb-10">
                    <div className="flex items-center gap-3">
                        {/* Иконка логотипа как в референсе */}
                        ...
                        return (
                            <button
                                ...
                                className={`flex items-center gap-3 rounded-xl px-4 py-3.5 transition-all duration-200 group ${
                                    isActive
                                        ? 'bg-[#42f042]/15 text-[#0d1b0d]' // Светло-зеленый фон для активной страницы
                                        : 'text-[#586458] hover:bg-[#42f042]/10 hover:text-[#0d1b0d]' // При наведении тоже чуть подсвечиваем
                                }`}
                            >
