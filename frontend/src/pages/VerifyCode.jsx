...
const VerifyCode = () => {
    ...
    const handleResend = async () => {
        ...
        try {
            ...
            setError('Ошибка сети при повторной отправке');
        } finally {
                ...
                <div className="w-full max-w-md z-10">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-sm text-[#4c9a4c] max-w-xs mx-auto">
                            Мы отправили 6-значный код на почту <span className="font-semibold text-[#0d1b0d]">{email}</span>
                        </p>
                    </div>
                    ...
                    <p className="mt-6 text-center text-sm text-[#4c9a4c]">
                        ...
                        >
                            {resendLoading ? 'Отправка...' : 'отправьте ещё раз'}
                        </button>
                    </p>
                </div>
            </main>
