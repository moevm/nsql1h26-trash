                ...
                <header className="h-20 flex items-center justify-between px-8 border-b border-slate-200 bg-white shrink-0 z-10">
                    ...
                    <div className="relative">
                        <span className="absolute inset-y-0 left-0 flex items-center pl-3">
                            <span className="icon-base text-slate-400 text-xl">search</span>
                        </span>
                    ...
                    <div className="max-w-7xl mx-auto">
                        <div className="table-wrapper">
                            ...
                            <div className="px-6 py-4 border-t border-slate-100 bg-slate-50/30 flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-2">
                                    <button className="px-3 py-1.5 rounded-lg border border-slate-200 text-sm font-medium text-slate-500 hover:bg-white hover:text-text-main transition-colors">Предыдущая</button>
                                    ...
                                    <button className="w-8 h-8 flex items-center justify-center rounded-lg border border-slate-200 text-slate-500 hover:bg-white hover:text-text-main transition-colors text-sm font-medium">2</button>
                                    <button className="px-3 py-1.5 rounded-lg border border-slate-200 text-sm font-medium text-slate-500 hover:bg-white hover:text-text-main transition-colors">Следующая</button>
                                </div>
                            </div>
                        </div>
                    </div>
